      ...
      <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center items-start text-left p-10 bg-white">
          <div className="max-w-lg">
            <h1 className="text-3xl font-semibold text-black mt-3">{video.title}</h1>

            <p className="mt-5 font-bold">
              Ciao! Sto mettendo a punto gli ultimi dettagli!
            </p>
            <p>Nel frattempo, prepara il tuo drink preferito, fai quella corsa dell’ultimo minuto in bagno e mettiti comodo. 🚀</p>
            <p>Tra pochi minuti ci tufferemo insieme in un viaggio che potrebbe trasformare la tua carriera! 🔥</p>

            <h3 className="mt-6 text-lg font-bold">In questa masterclass, ...</h3>
            <ul className="list-disc pl-5 space-y-2 mt-2">
              {parseTexts(video.texts).map((text, index) => (
            ...
            <div className="mt-6 flex items-center space-x-4 p-4 border rounded-lg bg-gray-100 w-full">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Career Strategist</p>
              </div>
            </div>
          </div>
        </div>
